...
export const databaseService = {
  ...
  // VIVA-SIMULATOR domain functions (createVivaSimulation,
  // getVivaSimulations, getVivaVignettes, chiefCreateVivaVignette,
  // chiefUpdateVivaVignette, chiefDeleteVivaVignette) moved verbatim to
  // src/lib/services/vivaSimulatorService.ts (Modularization Phase 4D) and
  // spread in here so every existing databaseService.X(...) call site keeps
  // working unchanged. See that file for their bodies/comments.
  ...vivaSimulatorService,
