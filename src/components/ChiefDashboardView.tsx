...
import { Collection, WorkforceMember, SubmissionWithWorkforce, Category, Submission, Announcement, AnnouncementCategory } from '../types';
import {
  Users,
  Clock,
  CheckCircle,
...
export const ChiefDashboardView: React.FC<ChiefDashboardViewProps> = ({ onLogout }) => {
  ...
  const [activeTab, setActiveTab] = useState<'submissions' | 'pending' | 'workforce' | 'announcements' | 'settings'>('submissions');
