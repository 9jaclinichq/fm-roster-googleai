...
import { Hourglass, LogOut, FlaskConical, Stethoscope, ChevronRight, IdCard, Camera, MessageSquare } from 'lucide-react';
          ...
          <div className="space-y-2 pt-2 border-t border-slate-100">
            ...
            >
              <span className="flex items-center space-x-3">
                ...
                <span>
                  <span className="block text-sm font-bold text-slate-800">Communication Hub</span>
                  <span className="block text-[11px] text-slate-500 mt-0.5">Contact preferences, support and PrivyDoc access</span>
                </span>
              </span>
              <ChevronRight size={16} className="text-slate-400 shrink-0" />
            </button>
