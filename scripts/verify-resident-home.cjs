...
check('Institutional Account Linking V1 advances the product migration ceiling to 86 while excluding parked migrations 82 and 83', (() => {
  ...
  return Math.max(...numbers) === 86 && !numbers.has(82) && !numbers.has(83);
})());
