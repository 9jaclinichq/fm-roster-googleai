...
check('Tenant Admin Bootstrap advances the product migration ceiling to 87 while excluding parked migrations 82 and 83', (() => {
  ...
  return Math.max(...numbers) === 87 && !numbers.has(82) && !numbers.has(83);
})());
